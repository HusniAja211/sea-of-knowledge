        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center gap-10">
                ...
                <div class="hidden sm:flex items-center gap-8">
                    <x-nav-link :href="route('admin.index')" :active="request()->routeIs('index')" class="text-white hover:text-white transition">
                        Dashboard
                    </x-nav-link>

                    <x-nav-link :href="route('admin.seller.index')" :active="request()->routeIs('dashboard')" class="text-white hover:text-white transition">
                        Sellers
                    </x-nav-link>
