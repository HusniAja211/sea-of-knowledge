            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-6">
                <div>
                    <h1 class="text-4xl font-extrabold text-secondary tracking-tight">
                        Sellers <span class="text-primary underline decoration-tertiary/30 text-5xl">.</span>
                    </h1>
                    <p class="text-slate-500 mt-2 flex items-center gap-2">
                        <span class="w-8 h-[2px] bg-tertiary"></span>
                        Manage and organize sellers account effectively.
                    </p>
                </div>
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-5 whitespace-nowrap text-right">
                                        <div class="flex justify-end items-center gap-2">
                                            ...
                                            <button type="button"
                                                onclick="confirmDelete('{{ route('admin.seller.destroy', $seller->id) }}')"
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-8 py-12 text-center text-slate-400 italic">
                                        No sellers data available at the moment.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
