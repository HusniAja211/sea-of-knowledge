        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex items-center space-x-2 text-sm">
                <a href="{{ route('admin.buyer.index') }}"
                    class="text-slate-500 hover:text-primary transition">Buyer</a>
                <span class="text-slate-400">/</span>
                <span class="font-bold text-secondary">Add New Buyer</span>
            </div>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        <div class="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                            ...
                            <p class="text-sm text-slate-600 leading-relaxed">
                                ...
                                verifikasi identitas dan pencairan dana buyer.
                            </p>
                        ...
                        <div class="bg-white rounded-2xl shadow-xl border-t-4 border-primary overflow-hidden">
                            <div class="p-8">
                                ...
                                <div class="mb-8 pb-6 border-b border-slate-100 flex justify-between items-end">
                                    <div>
                                        <h2 class="text-2xl font-bold text-secondary">Buyer Registration</h2>
